...
import { skills, experiences, projects, testimonials, aggregateInsights } from './variables'

const navItems = ['about', 'snapshot', 'impact', 'skills', 'experience', 'projects', 'testimonials', 'contact']
